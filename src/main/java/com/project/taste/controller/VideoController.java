...
public class VideoController {
     ...
     */
    @ResponseBody
    @RequestMapping("/video/query/userid")
    public Object queryVideoAllByid(@Param("userId") String userId,@Param("pageNum") Integer pageNum,@Param("pageSize") Integer pageSize){
        JsonResult result=null;
        try{
            PageHelper.startPage(pageNum,pageSize);
